...
export class AppComponent {
  ...
  laptops : Laptop[] = [
    {name : "Asus-Vivobook", price : 95000, discount : 0.10, discountPercentage : "10%", imgLoc : "assets/images/asus-vivobook.png", description : "A laptop is a portable computer with a built-in screen, keyboard, and battery, used for work, gaming, or browsing."},
